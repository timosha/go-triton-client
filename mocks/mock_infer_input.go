...
func (m *MockInferInput) GetData() []any {
	m.ctrl.T.Helper()
...
func (m *MockInferInput) GetParameters() map[string]any {
	m.ctrl.T.Helper()
...
func (m *MockInferInput) SetData(inputTensor any, binaryData bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockInferInputMockRecorder) SetData(inputTensor, binaryData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInferInputMockRecorder) SetDatatype(datatype any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInferInputMockRecorder) SetShape(shape any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
